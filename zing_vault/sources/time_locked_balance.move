module zing_vault::time_locked_balance {
    use std::u64;
    use sui::{balance::{Self, Balance}, clock::Clock};
    use zing_vault::util::timestamp_sec;
    ...
    fun calc_final_unlock_ts_sec(start_ts: u64, amount_to_issue: u64, unlock_per_second: u64): u64 {
