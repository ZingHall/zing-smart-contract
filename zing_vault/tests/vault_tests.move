module zing_vault::time_locked_balance_tests {
    use sui::{balance::{Self, Balance}, clock::{Self, Clock}};
    use zing_vault::time_locked_balance::{Self as tlb, TimeLockedBalance};
    ...
    fun test_create_clock_locked_balance() {
        // 10 seconds, round
        let tlb = tlb::create(
            balance::create_for_testing<FOO>(100),
            133,
            10,
        );
        ...
        let tlb = tlb::create(
            balance::create_for_testing<FOO>(101),
            133,
            10,
        );
        ...
        // zero balance
        let tlb = tlb::create(
            balance::create_for_testing<FOO>(0),
            133,
            10,
        );
    ...
    fun test_extraneous_locked_amount() {
        let tlb = tlb::create(
            balance::create_for_testing<FOO>(1021),
            158,
            13,
        );
